...
$read_sql = "Select * from bus where origin = '$source' and destination='$reach'";
		...
		<table>
			...
			?>
					 <tr>
						...
						<!--<td> <a href="buy.php?id=<?php echo $data_array["id"]; ?>">BOOKING</a></td>-->
						<td><a href="buy.php?id=<?php echo $data_array["id"]; ?>" class="btn btn-primary ">BOOK TICKET</a></td>
